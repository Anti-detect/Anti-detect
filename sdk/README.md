...
Scenarios: lifecycle, Playwright/Selenium attach, proxy quick profile, rotation, smoke, login, cookies, cloud export, worker sharding — [cookbook index](../docs/multilogin-api/cookbook/README.md).
...
mlx doctor
mlx start
# or: python recipes/01_saved_profile_lifecycle.py
```
...
| Language | Recipe |
|----------|--------|
| Python | [`python/recipes/`](python/recipes/) (**12** scenarios) · [`mlx_cli.py`](python/mlx_cli.py) |
...
[Multilogin pricing](https://multilogin.com/pricing/?utm_source=saas&utm_medium=partner&a_aid=saas&a_bid=f5fad549) · [CTA guide](../docs/pricing-cta.md)

---

**Get Multilogin X:** [Checkout](https://multilogin.com/pricing/?utm_source=saas&utm_medium=partner&a_aid=saas&a_bid=f5fad549) — **`SAAS50`** · **`MIN50`**
